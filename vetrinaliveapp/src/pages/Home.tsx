...
import { SidebarUpper,SidebarLower } from "../components/interface/SidebarInterface";
import {SidebarItems} from "../components/interface/DashboardInterface";
    ...
    <ThemeProvider theme={mdTheme}>
      <Box sx={{ display: "flex", height: "100vh" }}>
        ...
        <Drawer variant="permanent" open={open} sx={{}}>
            ...
            {/* SIDEBAR MENU ITEMS */}
            <List component="nav">
            {SidebarUpper.map((item: SidebarItems, index: number) => (
                <SidebarMenu item={item} key={index} open={open} />
            ))}
            <Divider sx={{ my: 1 }} />
            {SidebarLower.map((item: SidebarItems, index: number) => (
                <SidebarMenu item={item} key={index} open={open} />
            ))}
            </List>
        ...
        <Toolbar />
            ...
            >
                ...
                maxWidth="xl"
                >
                <Typography variant="h4">Welcome Soares!</Typography>
                    <Box
                        sx={{
                        py: [2],
                        display: "flex",
