...
export type VisitorsWithOrdersContainerProps = {
...
const VisitorsWithOrdersContainer: FC<VisitorsWithOrdersContainerProps> = ({
  children,
  cardLable,
  Icon,
  hasDate,
...
export default VisitorsWithOrdersContainer;
